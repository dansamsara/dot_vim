...
require("claude").setup({
  ...
  prompts = {
    Commit = {
      prompt = "Write a commit message for the staged changes following the style guide in @/home/ubuntu/co/backend/.cursor/rules/engbook/git-commit-style-guide.mdc",
    },
  },
})
