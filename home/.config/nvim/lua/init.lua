...
if is_mcphub_available then
  mcphub.setup({
    ...
    workspace = {
      -- Use the same mcp workspace for all projects
      enabled = false,
    },
  })
end
