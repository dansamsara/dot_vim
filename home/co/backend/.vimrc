...
if has('linux')
  let s:python3 = s:project_root . '/opt/pyenv/shims/python3'
...
let g:ale_linters = {}
let g:ale_linters.go = ['goimports', 'golangci-lint', 'staticcheck']
...
let g:test#go#gotest#executable = 'PRINT_LOGS=1 go test'
